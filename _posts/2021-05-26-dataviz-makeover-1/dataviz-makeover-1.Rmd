...
1.	The use of colors to distinguish exports and imports is too pale. And since most of the sub-charts have those two colors overlapped, it is very hard to understand. Brighter and distinct coloration is always preferred.
...
1.	In the y-axis, tick marks are added since it is on a continuous scale. In addition, the tick marks were also changed to black color to make them visible to the naked eye.

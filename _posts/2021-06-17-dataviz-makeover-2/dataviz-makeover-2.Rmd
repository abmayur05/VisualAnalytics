...
<center>
![Figure 5: Data Interpreter](img/5.png){width=40%}
...
<center>
![Figure 7: Add Clean Step Node](img/7.png){width=40%}
...
<center>
![Figure 9: Exclude Records](img/9.png){width=70%}
...
<center>
![Figure 13: Data Type Conversion](img/13.png){width=30%}
...
<center>
![Figure 14: Output Flow](img/14.png){width=30%}
...
<center>
![Figure 21: Import Column Formula](img/21.png){width=80%}
...
<center>
![Figure 22: Total Trade Column Formula](img/22.png){width=80%}
...
<center>
![Figure 26: Calculated Field Formula](img/26.png){width=80%}
...
<center>
![Figure 29: Calculated Field Formula](img/29.png){width=80%}
...
<center>
![Figure 40: Tooltip Flyout](img/40.png){width=70%}
...
<center>
![Figure 43: Add Date in Columns Pane](img/43.png)
...
<center>
![Figure 44: Convert To Line Graph](img/44.png){width=30%}

</center>
39.	Drag and drop the ‘Country’ column onto the ‘Detail’ pane under the Marks tool box.

<center>
![Figure 45: Add Country To Detail](img/45.png){width=30%}
...
<center>
![Figure 48: Create Circle Graph](img/48.png){width=25%}
...
<center>
![Figure 50: Create Dual Axis](img/50.png){width=35%}
...
<center>
![Figure 51: Synchronize Axis](img/51.png){width=35%}
...
<center>
![Figure 53: Show Filters](img/53.png){width=30%}
...
<center>
![Figure 56: Format Tooltip](img/56.png){width=30%}
...
<center>
![Figure 57: Change Display Units](img/57.png){width=70%}
...
<center>
![Figure 59: Calculated Field](img/59.png){width=80%}
...
<center>
![Figure 60: Get Percentage Difference](img/60.png){width=80%}

</center>
54.	Create another two calculated fields to represent if the percentage difference is positive or negative.

<center>
![Figure 61: Calculated Field](img/61.png){width=80%}

</center>
<center>
![Figure 62: Calculated Field](img/62.png){width=80%}
